#' sounding
#'
#' Function calculates presently over 130 atmospheric thermal- and kinematic indices (e.g. CAPE, CIN, Lapse Rates, EHI, STP, SCP, etc...)
...
sounding <- function(pressure, altitude, temp, dpt, wd, ws, export_profile = 0, accuracy = 1){
