...
#' output = sounding_export(pressure = sounding_vienna$pressure, altitude = sounding_vienna$altitude,
#'                          temp = sounding_vienna$temp, dpt = sounding_vienna$dpt,  
#'                          wd = sounding_vienna$wd, ws = sounding_vienna$ws)
