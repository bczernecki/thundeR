...
The main goal of the  **thundeR** R package is to calculate severe weather related set of algorithms that can be used for analyze and visualize atmospheric (pseudo-)soundings.
